...
import { TableContextState, createTableContext, useTable } from './DataTableContext';
import { Pagination } from './pagination/Pagination';
import { SearchInput } from '../../../prefab/forms/SearchInput/SearchInput';
import { MultiSearch as MultiSearchInput } from '../../../prefab/forms/MultiSearch/MultiSearch';
...
export const DataTableEager = ({ children, className, footer, ...propsRest }: DataTableEagerProps) => {
  ...
  return (
    <DataTableSync
      ...
      {...propsRest}
      className={cx(
        'bkl-data-table-eager',
        { 'bkl-data-table-eager--loading': !status.ready },
        className,
      )}
      table={table}
      status={status}
