...
import type { FieldQuery, FilterQuery } from '../../../prefab/forms/MultiSearch/MultiSearch';
...
export type MultiSelectProps = Omit<ComponentPropsWithoutRef<'div'>, 'onSelect'> & {
...
export const MultiSelect = (props: MultiSelectProps) => {
  ...
  const formatSelected = (keys: string[]) => {
    if (keys.length === 0) {
      return placeholder;
    }
  ...
  const renderDropdown = () => {
    return (
      <ul
        ...
        className={cx('bkl-select__dropdown', scrollerProps.className)}
...
export type SelectProps = Omit<ComponentPropsWithoutRef<'div'>, 'onSelect'> & {
