...
export const useCollection = /*<E extends Element>*/() => {
  ...
  // Note: we want collections to scale to a large amount of items. That means the following state should in principle
  // never be updated. `componentId` is an exception, which should normally not be updated by the consumer. If you
  // need state that can be updated, use something like zustand instead of React context.
